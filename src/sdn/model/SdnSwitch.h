...
protected:
   ...
   */
  virtual bool HandlePacket (Ptr<Packet> packet, uint16_t inPort);
  /**
   ...
   */
  virtual void Flood(Ptr<Packet> packet, uint16_t portNum);
  /**
   ...
   */
  virtual void SendPacketInToController(Ptr<Packet> packet,Ptr<NetDevice> device, uint8_t reason = fluid_msg::of10::OFPR_NO_MATCH);
  /**
   ...
   */
  virtual void LogOFMsg (fluid_msg::OFMsg* msg);
   /**
  ...
  virtual std::string getNewSerialNumber ();
  /**
